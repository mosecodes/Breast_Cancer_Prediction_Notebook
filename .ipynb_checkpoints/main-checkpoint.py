...
# i_X, i_y = load_iris(as_frame=True, return_X_y=True)
# print(i_X)
# print(i_y)
# i_X_train, i_X_test, i_y_train, i_y_test = train_test_split(i_X, i_y, test_size=0.2, random_state=0)
set_config(transform_output="pandas")


# helper func for mutating the target array
def y_mutate(x):
    x = x.copy()
    if x.at[0] == 'Malignant':
        return 1
